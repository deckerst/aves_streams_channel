...
public final class StreamsChannel {
    ...
    private final class IncomingStreamRequestHandler implements BinaryMessageHandler {
        ...
        @Override
        public void onMessage(ByteBuffer message, @NonNull final BinaryReply reply) {
        ...
        private final class EventSinkImplementation implements EventChannel.EventSink {
            ...
            public void success(Object event) {
                if (hasEnded.get() || Objects.requireNonNull(streams.get(id)).sink != this) {
                    return;
                }
            ...
            public void endOfStream() {
                if (hasEnded.getAndSet(true) || Objects.requireNonNull(streams.get(id)).sink != this) {
                    return;
                }
